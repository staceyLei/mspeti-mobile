...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    // CourseListProvider course = Provider.of<CourseListProvider>(this);
    // course.setCourseList= _hotCourseData;
              ...
              return Stack(alignment: Alignment.centerLeft, children: <Widget>[
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      'HI ${user.student.studentName} ${TimeUtil.getTime(DateTime.now().hour)}好',
                                      style: TextStyle(
                                          fontSize: 18.0,
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold),
                ...
                if (this._barOpacity > 0)
                  NavBar(
                    ...
                    comonent: this.renderNavBar(user.student),
                    color: Color.fromRGBO(37, 177, 135, 1),
                  )
              ]);
            })));
